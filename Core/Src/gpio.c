...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, SPI_DC_RS_Pin|SPI_BLK_Pin|SPI_RST_Pin, GPIO_PIN_RESET);
  ...
  GPIO_InitStruct.Pin = KEY1_Pin|Encoder_B_Pin;
  ...
  GPIO_InitStruct.Pin = SPI_DC_RS_Pin|SPI_BLK_Pin|SPI_RST_Pin;
  ...
  /*Configure GPIO pins : PEPin PEPin */
  GPIO_InitStruct.Pin = Encoder_A_Pin|Encoder_Key_Pin;
